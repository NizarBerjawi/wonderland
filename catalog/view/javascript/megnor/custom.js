...
function productCarouselAutoSet() { 
	$("#content .product-carousel,.related .product-carousel,#special-grid .product-carousel,.banners-slider-carousel .product-carousel, #producttab .product-carousel, .homepage-testimonials-inner .product-carousel ").each(function() {
		...
		var slider = $("#content #" + objectID + ",.related #"+ objectID + ", #producttab #"+ objectID + ",.banners-slider-carousel #"+ objectID + ", #producttab #"+ objectID + ",  .homepage-testimonials-inner #"+ objectID);
...
function productListAutoSet() { 
	$("#content .productbox-grid, .related .productbox-grid").each(function(){
		var objectID = $(this).attr('id');
