<div class="row">
    <div class="col-sm-12">
        <fieldset id="account">
            ...
            <div class="form-group row">
                <div class="col-sm-6">
                    <label class="required" for="input-payment-firstname"><?php echo $entry_firstname; ?></label>
                    <input type="text" name="firstname" value="" placeholder="<?php echo $entry_firstname; ?>" id="input-payment-firstname" class="form-control" />
                </div>

                <div class="col-sm-6">
                    <label class="required" for="input-payment-lastname"><?php echo $entry_lastname; ?></label>
            ...
            <div class="form-group row">
                <div class="col-sm-6">
                    <label class="required" for="input-payment-email"><?php echo $entry_email; ?></label>
                    <input type="text" name="email" value="" placeholder="<?php echo $entry_email; ?>" id="input-payment-email" class="form-control" />
                </div>

                <div class="col-sm-6">
                    <label class="required" for="input-payment-telephone"><?php echo $entry_telephone; ?></label>
    ...
    <div class="col-sm-12">
        <fieldset id="address">
            ...
            <div class="form-group">
                <label class="required" for="input-payment-city"><?php echo $entry_city; ?></label>
                <input type="text" name="city" value="" placeholder="<?php echo $entry_city; ?>" id="input-payment-city" class="form-control" />
            </div>

            <div class="form-group">
                <label class="required" for="input-payment-country"><?php echo $entry_country; ?></label>
            ...
            <div class="form-group row">
                <div class="col-sm-6">
                    <label class="required" for="input-payment-postcode"><?php echo $entry_postcode; ?></label>
                ...
                <div class="col-sm-6">
                    <label class="required" for="input-payment-zone"><?php echo $entry_zone; ?></label>
        ...
        <fieldset>
            ...
            <div class="form-group row password-input" style="display: none;">
                ...
                <div class="col-sm-6">
                    <label class="required" for="input-payment-confirm"><?php echo $entry_confirm; ?></label>
