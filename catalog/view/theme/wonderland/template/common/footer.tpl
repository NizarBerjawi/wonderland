<footer>
  <div id="footer" class="container">
	 ...
	 <div class="content_footer_left"><?php echo $footerleft; ?> </div>
      <?php if ($informations) { ?>
      <div class="col-sm-3 col-sm-offset-2 column">
        ...
        <ul class="list-unstyled">
		 ...
		 <?php /*?> <li><a href="<?php echo $contact; ?>"><?php echo $text_contact; ?></a></li>
          ...
          <li><a href="<?php echo $sitemap; ?>"><?php echo $text_sitemap; ?></a></li><?php */?>
        </ul>
      </div>
      <?php } ?>
     ...
     <?php /* ?><div class="col-sm-3 column">
	  ...
	  <div class="col-sm-3 column">
        ...
        <ul class="list-unstyled">
          ...
          <li><a href="<?php echo $return; ?>"><?php echo $text_return; ?></a></li>
          <?php /*?><li><a href="<?php echo $sitemap; ?>"><?php echo $text_sitemap; ?></a></li><?php */?>
