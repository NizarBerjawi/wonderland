...
<div class="quickview-container">
    ...
    <?php } ?>
        ...
        <button type="button" id="button-cart2" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-lg btn-block"><?php echo $button_cart; ?></button>
            <button type="button"  class="btn btn-default wishlist"  onclick="parent.wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i><?php echo $button_wishlist; ?></button>
            <button type="button"  class="btn btn-default compare"  onclick="parent.compare.add('<?php echo $product_id; ?>');"><i class="fa fa-area-chart"></i><?php echo $button_compare; ?></button>
          </div>
