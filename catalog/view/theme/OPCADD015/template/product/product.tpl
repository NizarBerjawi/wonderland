...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
		  ...
		  <div id="additional-carousel" class="image-additional <?php if ($imageCount >= $sliderFor){?>product-carousel<?php }?>">
			...
			<div class="slider-item">
				<div class="product-block">
					<a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="elevatezoom-gallery" data-image="<?php echo $thumb; ?>" data-zoom-image="<?php echo $popup; ?>"><img src="<?php echo $thumb; ?>" width="100" height="120" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
			...
			<?php foreach ($images as $image) { ?>
				<div class="slider-item">
				<div class="product-block">
        			<a href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" class="elevatezoom-gallery" data-image="<?php echo $image['thumb']; ?>" data-zoom-image="<?php echo $image['popup']; ?>" ><img src="<?php echo $image['thumb']; ?>" width="100" height="120" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
				</div>
				</div>
	        <?php } ?>
    	  </div>
    ...
    <?php } ?>
        ...
        <?php if ($column_left || $column_right) { ?>
        <?php $class = 'col-sm-12 product-right'; ?>
        <?php } else { ?>
        <?php $class = 'col-sm-12 product-right'; ?>
        <?php } ?>
        ...
        <div class="<?php echo $class; ?>">
          <!-- <h3 class="product-title"><?php //echo $heading_title; ?></h3><br> -->
		      <!-- <?php if ($review_status) { ?> -->
        ...
        <span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i><i class="fa fa-star fa-stack-1x"></i></span>
              <?php } ?>
              <?php } ?>
              <a class="review-count" href="" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;"><?php echo $reviews; ?></a>
              <a class="write-review" href="" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;"><i class="fa fa-pencil"></i> <?php //echo $text_write; ?></a>
      </div>
          <?php } ?> -->
      ...
      <span class="old-price" style="text-decoration: line-through;"><?php echo $price; ?></span>
          ...
          <div id="product">
            ...
            <div class="form-group">
              ...
              <?php /* ?><button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-lg btn-block"><?php echo $button_cart; ?></button><?php */?>
		  ...
		  <div class="btn-group wish-comp">
           <button type="button" class="addtocart" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-lg btn-block"><?php echo $button_cart; ?></button>
           <button type="button"  class="btn btn-default wishlist"  onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i><?php echo $button_wishlist; ?><?php /*?><?php echo $button_wishlist; ?><?php */?></button>
            <button type="button"  class="btn btn-default compare"  onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-bar-chart"></i><?php echo $button_compare; ?><?php /* ?><?php echo $button_compare; ?><?php */?></button>
          ...
          <!-- Go to www.addthis.com/dashboard to customize your tools -->
          <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5a9b91fb711f7ffe"></script>
      ...
      ?>
       ...
       <span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i></span>
          ...
          <div class="button-group">
                      <button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');" title="Add to cart" data-toggle="tooltip" type="button"><span><?php echo $button_cart; ?></span></button>
                      ...
                      <div class="quickview" title="Quick View" data-toggle="tooltip"><a href="<?php echo $product['quick']; ?>"></a></div>


                     <?php /*?> <div class="quickview" data-toggle="tooltip" title="Quick View"> <a class="quickbox" href="<?php echo $product['quick']; ?>"></a></div><?php */?>
