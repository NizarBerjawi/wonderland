...
<link media="all" type="text/css" href="http://fonts.googleapis.com/css?family=Open+Sans:400,500,600,700" rel="stylesheet">
<link media="all" type="text/css" href="http://fonts.googleapis.com/css?family=Oswald:400,700" rel="stylesheet">

<link href="catalog/view/theme/<?php echo $mytemplate; ?>/stylesheet/stylesheet.css" rel="stylesheet">
<link href="catalog/view/theme/<?php echo $mytemplate; ?>/stylesheet/custom.css" rel="stylesheet">
  ...
  <div class="container">
    ...
    <div class="col-sm-2 header-cart"><?php echo $cart; ?></div>
     <div class="header_search">
      ...
      <div class="input-group searchtoggle" id="search" style="display: none;">
  <input type="text" class="form-control input-lg" placeholder="Search" value="" name="search" autofocus="autofocus">
  <span class="input-group-btn">
    <button class="btn btn-default btn-lg" type="button"><span class="button-search"></span></button>
  </span>
</div>
